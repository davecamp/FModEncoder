...
public:
	...
	virtual void SetOutputFilename(char* pFilename) = 0;
	virtual void SetEncoder(SRS_FMOD_ENCODER_CODEC eEncoderType) = 0;
	virtual void SetOutputBitrate(float fBitrate) = 0;
